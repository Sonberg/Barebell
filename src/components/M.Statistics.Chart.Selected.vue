<template>
    <div class="flex-wrap">
        <div class="py-4 md:p-4 w-1/2 md:w-full">
                <a-label value="Date" />
...
export default {
    ...
    computed: {
        ...
        reps() {
            return (this.item && this.item.reps || '-');
        },
        oneRm() {
            return displayWeight(this.item && this.item.oneRm);
        },
        volym() {
            return displayWeight(this.item && this.item.volym);
        }
    }
}
</script>
